...
if __name__ == '__main__':
    ...
    """
    "quantum for illustration figures"
    initial_setup = 'gaussian_wave'
    quantum_or_not = True
    distribution_params_list = [[0.7, 0]]
    alpha_list = [0.01]
    dt_list = [0.01]

    quantum_or_not = False
    distribution_params_list =  [0.7]
    alpha_list = [[0.01, 0.005]]
    initial_setup = 'normal_random'
    distribution_params_list =  [0.05]
    dt_list = [1]
    alpha_list = [[1, 0.1]]
    ...
    alpha_list = [1]
    initial_setup = 'u_normal_random_cutoff'
    distribution_params_list = [[0.05, 0.2, 0, 0.2], [0, 0.2, 0.05, 0.2]]
    """
